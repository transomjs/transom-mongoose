...
module.exports = function (options) {
    ...
    const publik = (defaultAclValue.public !== undefined ? defaultAclValue.public : INT_VALUE.READ | INT_VALUE.UPDATE | INT_VALUE.DELETE);
    const owner = (defaultAclValue.owner ? defaultAclValue.owner : {
        CURRENT_USER: (INT_VALUE.READ | INT_VALUE.UPDATE | INT_VALUE.DELETE)
    });
    ...
    return function (schema, options) {
        ...
        schema.statics.getGroupsWithAclCreate = function () {
            // The groups required to CREATE a record.
        ...
        schema.statics.setAclDefaults = function (req) {
            ...
            if (model.isNew && model[aclKey]) {
                ...
                props.forEach(function (prop) {
                    ...
                    if (aclProp && aclProp[CURRENT_USER]) {
        ...
        schema.query.aclCheck = function (aclOperation, req) {
            if (aclOperation === CRUD_STRING.READ ||
