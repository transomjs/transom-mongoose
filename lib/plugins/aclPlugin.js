...
module.exports = function (options) {
    ...
    const acl = (options.entity ? options.entity.acl : undefined) || {};
    const aclDefault = acl.default || {};
    ...
    return function (schema, options) {
        ...
        schema.statics.aclCreateGroups = function () {
            // The groups required to CREATE a record.
            let groups = acl.create || [];
        ...
        schema.methods.aclCreate = function (req) {
            const groups = schema.statics.aclCreateGroups();
            if (!schema.statics.hasGroup.call(this, req, groups)) {
                throw new Error(`Failed ACL check on ${CONSTANTS.CREATE}, requires one of [${groups.join(',')}] groups.`);
            }
