	...
	function mapToSchemaType(schemaType, customTypeKey) {
		...
		switch (schemaType) {
			...
			case "connector":
				...
				break;
			case "string":
				result[customTypeKey] = 'string'
				break;
			case "date":
			case "datetime":
				result[customTypeKey] = 'date'
			break;
			case "number":
            case 'integer':
            case 'int32':
			...
			case "binary":
				...
				binaryObj.binaryData[customTypeKey] = 'buffer';
				binaryObj.filename[customTypeKey] = 'string';
				binaryObj.mimetype[customTypeKey] = 'string';
				binaryObj.size[customTypeKey] = 'number';
			...
			case "point":
				...
				const pointObj = {
				  ...
				  pointObj.type[customTypeKey] = 'string';
				  pointObj.coordinates[customTypeKey] = ['number']; 
				...
				break;
			default:
				result[customTypeKey] = schemaType || 'string';
		}
		return result;
	}
