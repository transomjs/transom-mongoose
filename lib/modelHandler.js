	...
	function handleFind(req, res, next) {
		...
		modelFunctions.modelFind(entity, req)
			.then(function (data) {
				...
				next(new restifyErrors.BadRequestError(err, `Error executing ${entity.modelName} modelFind()`));
			});
	};
	...
	function handleFindById(req, res, next) {
		...
		modelFunctions.modelFindById(entity, req)
			.then(function (data) {
				...
				next(new restifyErrors.BadRequestError(err, `Error executing ${entity.modelName} modelFindById()`));
			});
	};
