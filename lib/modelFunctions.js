...
module.exports = function ModelFunctions(options) {
    ...
    function modelFind(entity, req) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            debug(`Error executing ${entity.modelName} model find()`, err);
            return Promise.reject(err);
        });
    }
    ...
    function modelFindById(entity, req) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (!item) {
                ...
                return Promise.reject(new restifyErrors.NotFoundError('Not Found'));
            }
    ...
    function modelFindBinary(entity, req) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            return Promise.resolve(item[req.params.__attribute]);
        }).catch(function (err) {
    ...
    function modelCount(entity, req) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            const query = handlerUtils.buildQuery(model.count(), req, entity);
            query.lean(true);
            ...
            debug(`Error executing ${entity.modelName} modelCount query`, err);
            return Promise.reject(err);
        });
    }
