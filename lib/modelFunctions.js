...
module.exports = function ModelFunctions(options) {
    ...
    function modelFindById(server, entity, req) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                ...
                return reject(createError(400, 'Invalid ID format'));
            }
    ...
    function modelInsert(server, entity, req) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (!doc._id){
                ...
                doc['_id'] = new Types.ObjectId().toHexString();    
            }
        ...
        return new Promise(function (resolve, reject) {
            ...
            query.deleteMany()
                .then(function (result) {
                    // Mongoose 5.x, removed.result looks like: 
                    //      { "ok": 1, "n": 2 } where 'n' is the number removed.
                    // Mongoose 6: `{ acknowledged: true, deletedCount: 2 }`
                    resolve({
                        data: {
                            deleted: (result.acknowledged ? result.deletedCount : -1)  // v6.x
                        }
                    });
                }).catch(function (err) {
    ...
    function modelDeleteById(server, entity, req) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            query.deleteOne().then(function (result) {
    ...
    function modelDeleteBatch(server, entity, req) {
        ...
        var p = new Promise(function (resolve, reject) {
            ...
            // Mongoose v5 removed.result looks like: { "ok": 1, "n": 2 } where 'n' is the number removed.
            // If NOT ok, return "-1".
            // Mongoose 6: `{ acknowledged: true, deletedCount: 2 }`
